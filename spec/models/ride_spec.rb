...
RSpec.describe Ride do
  describe 'validations' do
    ...
    it { is_expected.to validate_presence_of(:cost_per_rider) }
    it { is_expected.to validate_numericality_of(:available_seats).only_integer.is_greater_than_or_equal_to(0) }
